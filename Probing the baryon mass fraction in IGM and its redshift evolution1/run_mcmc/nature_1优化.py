...
coefficient = 21*3*10**5/64/np.pi/6.67/1.67/3.0836**2    # 1MPC = 3.0857*10**22 m 还要乘H0,omega,f_IGM才是完整的系数
scale = 1000
...
def dm_c_a(ob_h, z):   #dm_cosmic_average,h0 hided in omega_b
    ob = ob_h*70/h0_P
    return coefficient*f_IGM_p*(z+z**2/2)*ob*h0_P
...
my_workbook.save('nature_1优化.xlsx')
